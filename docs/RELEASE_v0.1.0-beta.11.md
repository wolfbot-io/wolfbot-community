# WolfBot Community v0.1.0-beta.11 — Free Self-Hosted Trading Platform for Linux
...
**Live Translate is back.** v0.1.0-beta.10's signed installer accidentally omitted the Live Translate service image. This release's signed manifest includes the full translator image set again, so a fresh v0.1.0-beta.11 install has Live Translate available out of the box. If you installed v0.1.0-beta.10, upgrade to v0.1.0-beta.11 to get it — reinstalling v0.1.0-beta.10 will not restore it.

**No new Windows build in this release.** v0.1.0-beta.11 ships Linux only. If you're on Windows, keep using the v0.1.0-beta.10 installer for now (same known market-data-reconnect issue as before); a corrected, code-signed Windows build will follow in an upcoming release.

## ⬇️ Download v0.1.0-beta.11

| Platform | File | Size | Download |
|---|---|---|---|
| 🐧 Linux — Debian / Ubuntu (`.deb`) | `WolfBot-Setup-linux-amd64.deb` | ~86 MB | **[⬇️ Download .deb](https://github.com/wolfbot-io/wolfbot-community/releases/download/v0.1.0-beta.11/WolfBot-Setup-linux-amd64.deb)** |
| 🐧 Linux — any distro (`.run`, self-extracting) | `wolfbot-oneclick-0.1.0-beta.11.run` | ~113 MB | **[⬇️ Download .run](https://github.com/wolfbot-io/wolfbot-community/releases/download/v0.1.0-beta.11/wolfbot-oneclick-0.1.0-beta.11.run)** |
...
WolfBot Community remains a Windows & Linux self-hosted trading platform. This release ships a signed Linux installer only; the existing v0.1.0-beta.10 Windows build remains the current Windows option until its corrected, code-signed successor ships.
