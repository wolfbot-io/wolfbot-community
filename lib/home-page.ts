...
export const HOME_COPY: Record<string, HomeCopy> = {
  en: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-p12-ghcr-rc19 is available',
  ...
  vi: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-p12-ghcr-rc19 đã có sẵn',
  ...
  zh: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-p12-ghcr-rc19 现已可用',
  ...
  'pt-br': {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-p12-ghcr-rc19 está disponível',
  ...
  ru: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-p12-ghcr-rc19 доступен',
  ...
  de: {
    ...
    stripPublicPreview: 'PUBLIC PREVIEW',
    stripReleaseAvailable: 'WolfBot Community v0.1.0-p12-ghcr-rc19 ist verfügbar',
  ...
  ja: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-p12-ghcr-rc19 が利用可能になりました',
  ...
  ko: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-p12-ghcr-rc19 사용 가능',
  ...
  hi: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-p12-ghcr-rc19 उपलब्ध है',
