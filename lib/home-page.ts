...
export const HOME_COPY: Record<string, HomeCopy> = {
  ...
  zh: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-beta.10 现已可用',
  ...
  'pt-br': {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-beta.10 está disponível',
  ...
  ru: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-beta.10 доступен',
  ...
  de: {
    ...
    stripPublicPreview: 'LATEST PUBLIC RELEASE',
    stripReleaseAvailable: 'WolfBot Community v0.1.0-beta.10 ist verfügbar',
  ...
  ja: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-beta.10 が利用可能になりました',
  ...
  ko: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-beta.10 사용 가능',
  ...
  hi: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-beta.10 उपलब्ध है',
