...
export const HOME_COPY: Record<string, HomeCopy> = {
  en: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-beta.4 is available',
  ...
  vi: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-beta.4 đã có sẵn',
  ...
  zh: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-beta.4 现已可用',
  ...
  'pt-br': {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-beta.4 está disponível',
  ...
  ru: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-beta.4 доступен',
  ...
  de: {
    ...
    stripPublicPreview: 'LATEST PUBLIC RELEASE',
    stripReleaseAvailable: 'WolfBot Community v0.1.0-beta.4 ist verfügbar',
  ...
  ja: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-beta.4 が利用可能になりました',
  ...
  ko: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-beta.4 사용 가능',
  ...
  hi: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-beta.4 उपलब्ध है',
