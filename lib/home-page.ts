...
export const HOME_COPY: Record<string, HomeCopy> = {
  en: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-p12-ghcr-rc8 is available',
    stripSeeRelease: 'See release →',
    heroBadge: 'WolfBot Community by WolfBot.io · Free & Self-Hosted',
    heroTitle1: 'Trade Every Market.',
    heroTitle2: 'From ',
  ...
  vi: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-p12-ghcr-rc8 đã có sẵn',
    stripSeeRelease: 'Xem bản phát hành →',
    heroBadge: 'WolfBot Community by WolfBot.io · Miễn Phí & Tự Lưu Trữ',
    heroTitle1: 'Giao Dịch Mọi Thị Trường.',
    heroTitle2: 'Từ ',
  ...
  zh: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-p12-ghcr-rc8 现已可用',
  ...
  'pt-br': {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-p12-ghcr-rc8 está disponível',
    stripSeeRelease: 'Ver lançamento →',
    heroBadge: 'WolfBot Community by WolfBot.io · Grátis e Auto-Hospedado',
    heroTitle1: 'Negocie Todos os Mercados.',
    heroTitle2: 'Em ',
  ...
  ru: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-p12-ghcr-rc8 доступен',
    stripSeeRelease: 'Смотреть релиз →',
    heroBadge: 'WolfBot Community by WolfBot.io · Бесплатно и cамохостинг',
    heroTitle1: 'Торгуйте на любом рынке.',
    heroTitle2: 'С ',
  ...
  de: {
    ...
    stripPublicPreview: 'PUBLIC PREVIEW',
    stripReleaseAvailable: 'WolfBot Community v0.1.0-p12-ghcr-rc8 ist verfügbar',
    stripSeeRelease: 'Release ansehen →',
    heroBadge: 'WolfBot Community by WolfBot.io · Kostenlos & selbstgehostet',
    heroTitle1: 'Handeln Sie jeden Markt.',
    heroTitle2: 'Von ',
  ...
  ja: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-p12-ghcr-rc8 が利用可能になりました',
    stripSeeRelease: 'リリースを見る →',
    heroBadge: 'WolfBot Community by WolfBot.io · 無料＆セルフホスト',
    heroTitle1: 'あらゆる市場で取引。',
    heroTitle2: 'ひとつの',
    heroTitleGradient: 'プラットフォーム',
  ...
  ko: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-p12-ghcr-rc8 사용 가능',
    stripSeeRelease: '릴리스 보기 →',
    heroBadge: 'WolfBot Community by WolfBot.io · 무료 및 자체 호스팅',
    heroTitle1: '모든 시장에서 거래하세요.',
    heroTitle2: '',
    heroTitleGradient: '하나의 플랫폼',
  ...
  hi: {
    ...
    stripReleaseAvailable: 'WolfBot Community v0.1.0-p12-ghcr-rc8 उपलब्ध है',
    stripSeeRelease: 'रिलीज़ देखें →',
    heroBadge: 'WolfBot Community by WolfBot.io · निःशुल्क और सेल्फ-होस्टेड',
    heroTitle1: 'हर बाज़ार में ट्रेड करें।',
    heroTitle2: '',
    heroTitleGradient: 'एक प्लेटफ़ॉर्म',
