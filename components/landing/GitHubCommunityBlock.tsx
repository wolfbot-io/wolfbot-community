export function GitHubCommunityBlock() {
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t border-zinc-800">
      ...
      <p className="text-zinc-400 text-center mb-12 max-w-lg mx-auto">Follow development, ask questions and share feedback.</p>
      <div className="grid sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
        {[
          ...
          <a key={item.label} href={item.href} target="_blank" rel="noopener noreferrer" className="border border-zinc-800 rounded-xl p-6 text-center hover:border-zinc-600 transition-colors bg-zinc-900/50">
