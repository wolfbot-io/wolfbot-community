    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t border-zinc-800">
      ...
      <div className="max-w-2xl mx-auto border border-zinc-800 rounded-xl p-8 bg-zinc-900/50">
        <div className="flex items-center gap-3 mb-4">
          <span className="bg-blue-600/20 text-blue-400 text-xs font-semibold px-2 py-0.5 rounded">
            PUBLIC PREVIEW
          </span>
        ...
        <p className="text-zinc-400 text-sm mb-6">
          Latest public preview with installation improvements and broker updates.
        </p>
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <a
            href="https://github.com/wolfbot-io/wolfbot-community/releases/latest"
            target="_blank"
