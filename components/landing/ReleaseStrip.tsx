      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        <div className="flex flex-wrap items-center justify-center sm:justify-between gap-2 text-sm">
          <div className="flex items-center gap-2">
            ...
            <span style={{ color: '#94A3B8' }}>WolfBot Community v0.1.0-p12-ghcr-rc8 is available</span>
          </div>
          <div className="flex items-center gap-3" style={{ color: '#94A3B8' }}>
            ...
            <Link href="/releases" className="hover:underline" style={{ color: '#00C9E8' }}>See release →</Link>
          </div>
        </div>
      </div>
    </div>
