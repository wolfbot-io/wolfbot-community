...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (localeConf) {
    ...
    const description = copy?.metaDescription ?? 'Free self-hosted unified trading platform for Windows and Linux. Connect crypto exchanges, futures, MT5 markets and TradingView automation through one intelligent interface.'
