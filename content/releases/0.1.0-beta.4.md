...
description: "WolfBot Community v0.1.0-beta.4 was a reliability and infrastructure hardening release: fixed in-app update checks, more resilient background safety jobs, robust .deb upgrades, and automatic MT5/DCA self-healing. See the latest release for current downloads."
...
next_guide: "/releases/0.1.0-beta.9"
previous_guide: "/releases/0.1.0-beta.2"
related_guides: ["/releases/0.1.0-beta.9", "/download", "/install/linux", "/docs/tradingview", "/docs/simulation", "/docs/risk-controls", "/docs/how-to-verify-a-downloaded-trading-bot"]
keywords: [
...
> A newer release is available. See **[WolfBot Community v0.1.0-beta.9 release notes →](/releases/0.1.0-beta.9)** for the current download, the new Live Translate feature, and what's changed since this release.

WolfBot Community v0.1.0-beta.4 was a public release of the free, self-hosted WolfBot trading platform for Windows and Linux users. This is a reliability and infrastructure hardening release, focused on making the self-hosted install experience smoother and the in-app update flow trustworthy end to end.
...
> **[See what's new in WolfBot Community v0.1.0-beta.9 →](/releases/0.1.0-beta.9)**
