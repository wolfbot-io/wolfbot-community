---
title: "WolfBot Community v0.1.0-beta.10 — Free Self-Hosted Trading Platform for Windows & Linux"
description: "WolfBot Community v0.1.0-beta.10 fixes automated model selection on fresh installs, MT5 self-serve bridge reliability, adds a persistent MT5 VNC entry point, and hardens every service against long-uptime file-descriptor exhaustion."
...
next_guide: "/releases/0.1.0-beta.11"
previous_guide: "/releases/0.1.0-beta.9"
related_guides: ["/releases/0.1.0-beta.11", "/download", "/install/linux", "/docs/tradingview", "/docs/simulation", "/docs/risk-controls", "/docs/how-to-verify-a-downloaded-trading-bot"]
keywords: [
...
**Tested with WolfBot Community v0.1.0-beta.10** · Last updated: 2026-09-20

> A newer release is available for Linux. See **[WolfBot Community v0.1.0-beta.11 release notes →](/releases/0.1.0-beta.11)** for the current Linux download and what's changed since this release. **Windows users:** v0.1.0-beta.11 shipped Linux-only, so this page's Windows `.exe` remains the current Windows download until a corrected build ships.

WolfBot Community v0.1.0-beta.10 was a public release of the free, self-hosted WolfBot trading platform for Windows and Linux users. This is a reliability release focused on making the automated model-selection engine and MT5 self-serve connections trustworthy from the very first install, plus infrastructure hardening so future installs are immune to a class of long-uptime failures out of the box.
...
**Known issue (verified 2026-09-21):** the signed beta.10 installer does not include the Live Translate service image. Reinstalling the same beta.10 package will not restore it; a subsequent versioned installer is required.

## Download v0.1.0-beta.10

| Platform | File | Size | Download |
|---|---|---|---|
| 🐧 Linux — Debian / Ubuntu (`.deb`) | `WolfBot-Setup-linux-amd64.deb` | ~86 MB | **[Download .deb](https://github.com/wolfbot-io/wolfbot-community/releases/download/v0.1.0-beta.10/WolfBot-Setup-linux-amd64.deb)** |
| 🐧 Linux — any distro (`.run`, self-extracting) | `wolfbot-oneclick-0.1.0-beta.10-0.1.0.run` | ~113 MB | **[Download .run](https://github.com/wolfbot-io/wolfbot-community/releases/download/v0.1.0-beta.10/wolfbot-oneclick-0.1.0-beta.10-0.1.0.run)** |
| 🪟 Windows — 64-bit installer (`.exe`) | `WolfBot-Setup-0.1.0-beta.10-windows-x64.exe` | ~457 MB | **[Download .exe](https://github.com/wolfbot-io/wolfbot-community/releases/download/v0.1.0-beta.10/WolfBot-Setup-0.1.0-beta.10-windows-x64.exe)** |
...
## What is new since v0.1.0-beta.9
...
### MT5 VNC session — open it anytime
...
Live Translate is unavailable in the beta.10 installer because its service image was omitted from the signed release manifest. The feature remains in the codebase and must return in a newly signed release.
...
- Live Translate is unavailable in this beta.10 installer; see the known issue above.
...
> **[See what's new in WolfBot Community v0.1.0-beta.11 →](/releases/0.1.0-beta.11)** (Linux). Still on Windows? **[Download WolfBot Community v0.1.0-beta.10 for Windows →](/download)**
