...
**Tested with WolfBot Community v0.1.0-beta.10** · Last updated: 2026-08-24
...
WolfBot Community is on the public release track with **v0.1.0-beta.10** available now.

```text
Current public: v0.1.0-beta.10
```
...
- The latest detailed release notes are here: [v0.1.0-beta.10](/releases/0.1.0-beta.10)
