...
description: "WolfBot Community v0.1.0-beta.9 adds Live Translate, a local real-time speech and text translation feature, plus reliability fixes across Bybit, KuCoin, Bitget, MT5, Telegram notifications and the Terminal."
...
WolfBot Community v0.1.0-beta.9 is the latest public release of the free, self-hosted WolfBot trading platform for Windows and Linux users. This release introduces **Live Translate** — a real-time speech and text translation feature built directly into WolfBot Community — plus a large set of reliability fixes accumulated since v0.1.0-beta.4.
...
> **[Download WolfBot Community v0.1.0-beta.9 →](/download)**
