...
**Đã kiểm thử với WolfBot Community v0.1.0-p12-ghcr-rc8** · Cập nhật lần cuối: 2026-08-12 · Windows 11 / Windows 10

> ℹ️ **Tình trạng khả dụng:** bản phát hành công khai đầu tiên (v0.1.0-p12-ghcr-rc8) đi kèm trình cài đặt Linux. Trình cài đặt Windows được mô tả ở đây trước khi bản phát hành tiếp theo ra mắt — xem [trang download](/download) để biết tình trạng hiện tại, và hướng dẫn này sẽ dẫn bạn đi từng bước ngay khi nó khả dụng.
