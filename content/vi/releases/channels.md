...
**Đã kiểm thử với WolfBot Community v0.1.0-beta.10** · Cập nhật lần cuối: 2026-08-11
...
WolfBot Community hiện đang ở kênh phát hành công khai **v0.1.0-beta.10**.

```text
Stable: Chưa phát hành
Public hiện tại: v0.1.0-beta.10
```
