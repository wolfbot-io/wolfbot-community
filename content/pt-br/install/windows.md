...
**Testado com WolfBot Community v0.1.0-p12-ghcr-rc21** · Última atualização: 2026-08-15 · Windows 11 / Windows 10

> ℹ️ **Disponibilidade:** o primeiro lançamento público (v0.1.0-p12-ghcr-rc21) traz o instalador para Linux. O instalador para Windows está documentado aqui antes do seu lançamento futuro — confira a [página de download](/download) para o status atual, e este guia vai te orientar assim que ele estiver disponível.
