...
3. 登录你的经纪商账户(模拟或实盘)
   ...
   - **Linux:** 直接在 WolfBot 的浏览器窗口中完成登录——仅首次需要一个简单的一次性设置步骤(参见下方[技术用户须知](#for-technical-users))
...
以下内容适合想了解 MT5 桥接具体工作原理、或更喜欢通过终端完成 Linux 设置步骤的用户。使用 WolfBot 中的 MT5 功能并不需要阅读这部分内容——正常流程请参阅上方的[连接 MT5](#connect-mt5)。
