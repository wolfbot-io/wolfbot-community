...
**Getestet mit WolfBot Community v0.1.0-beta.10** · Zuletzt aktualisiert: 2026-08-15 · Windows 11 / Windows 10

> ℹ️ **Verfügbarkeit:** die erste öffentliche Version (v0.1.0-beta.10) liefert den Linux-Installer. Der Windows-Installer wird hier vor seinem Folge-Release dokumentiert — prüfe die [Download-Seite](/download) für den aktuellen Status, und dieser Guide führt dich durch, sobald er verfügbar ist.
